...
public class Util {
    public static boolean isJNIOnLoad(Function m) {
        return m.name.equals("JNI_OnLoad") && m.clazz.equals("@");
    }

    public static JsonArray mergeJsonArrays(JsonArray first, JsonArray ... arrs) {
    ...
    public static <T> HashSet<T> array2Set(T[] arr) {
        return new HashSet<>(Arrays.asList(arr));
    }

    public static String[] jniApiNames = new String[] {
    ...
    public static final Set<String> jniApiNameSet = new HashSet<>(Arrays.asList(jniApiNames));

    public static boolean isJNIAPI(String apiname) {
        return jniApiNameSet.contains(apiname);
    }
}
